...
public class Util
{
    static public Dictionary<T, GameObject> mapDictionarywithEnum<T>(GameObject go) where T : Enum
    {
    ...
    static public Dictionary<T, T2> mapDictionaryWithEnumAndLoad<T, T2>(string filePath) where T : Enum where T2 : UnityEngine.Object
    {
